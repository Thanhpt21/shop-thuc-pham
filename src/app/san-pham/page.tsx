...
const FilterItem = ({
  ...
  const colors = {
    ...
    shadow: isSelected ? "shadow-lg shadow-green-500/20" : "shadow-sm",
  };
          ...
          {selectedCategory && (
            <>
              ...
              <Link
                ...
                className="text-gray-500 hover:text-green-600 transition-colors truncate max-w-[150px]"
              >
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-green-50 to-white">
        <div className="text-center p-8 bg-white rounded-2xl shadow-xl border border-gray-100 max-w-md">
          ...
          <Button
            ...
            className="!bg-gradient-to-r !from-green-600 !to-emerald-600 !border-0 hover:!from-green-700 hover:!to-emerald-700"
          >
            Thử lại
          </Button>
        </div>
    ...
    <div className="min-h-screen w-full">
      ...
      <div className="max-w-7xl mx-auto py-4 lg:py-8">
        {(selectedCategoryId || selectedBrandId || showFeatured || showPromoted || getCurrentParams().search || currentPage > 1) && (
          <div className="mb-6 lg:mb-8 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-4 border border-green-200">
            <div className="flex flex-wrap items-center gap-3">
              ...
              {getCurrentParams().search && (
                <Tag
                  ...
                  className="!px-3 !py-1.5 !rounded-full !bg-white !text-green-700 !border-green-300 shadow-sm"
                >
                  {getCurrentParams().search}
                </Tag>
              )}
              ...
              {selectedBrand && (
                <Tag
                  ...
                  className="!px-3 !py-1.5 !rounded-full !bg-white !text-emerald-700 !border-emerald-300 shadow-sm"
                >
                  {selectedBrand.name}
                </Tag>
              )}
              ...
              {showFeatured && (
                <Tag
                  ...
                  className="!px-3 !py-1.5 !rounded-full !bg-gradient-to-r !from-emerald-50 !to-green-50 !text-emerald-700 !border-emerald-300 shadow-sm"
                >
                  Nổi bật
                </Tag>
              )}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
              ...
              <div className="bg-white rounded-xl border border-gray-200 shadow-sm">
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-800">Nguồn gốc / Nông trại</h4>
                      <p className="text-xs text-gray-500">
                        {visibleBrands.length} nguồn
                      </p>
                    </div>
                  </div>
                  <ChevronDown 
          ...
          <button
            ...
            className="lg:hidden fixed bottom-6 right-6 z-50 w-14 h-14 bg-gradient-to-r from-green-600 to-emerald-600 text-white rounded-full shadow-lg flex items-center justify-center hover:shadow-xl transition-all active:scale-95"
          >
            <Filter size={20} />
          </button>
          ...
          {showMobileFilters && (
            <>
              ...
              <div className="lg:hidden fixed right-0 top-0 bottom-0 z-[9999] w-80 bg-white shadow-xl animate-slideInRight">
                <div className="flex-shrink-0 bg-gradient-to-r from-green-600 to-emerald-600 p-4">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-white rounded-lg border border-gray-200">
                      <div
                        ...
                        onClick={() => setShowBrandsFilter(!showBrandsFilter)}
                      >
                        <span className="font-medium text-gray-800">Nguồn gốc / Nông trại</span>
                        <ChevronDown 
                          size={16} 
          ...
          <div className="lg:col-span-9">
                ...
                <div>
                  <h1 className="text-2xl font-bold text-gray-800 mb-2">
                    {getCurrentParams().search ? (
                      <>
                        Kết quả tìm kiếm:{" "}
                        <span className="text-green-600">"{getCurrentParams().search}"</span>
                      </>
                    ) : selectedCategory ? (
                      selectedCategory.name
                    ) : (
            ...
            {products.length > 0 ? (
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
                    {products.map((product, index) => {
                      ...
                      if (product.promotionProducts && product.promotionProducts.length > 0) {
                        return (
                          <div key={`${product.id}-${currentPage}`} className="transform transition-transform duration-150 hover:-translate-y-0.5">
                            <ProductCardPromoted product={product} index={globalIndex} />
                          </div>
                        );
                      } else if (product.isFeatured) {
                        return (
                          <div key={`${product.id}-${currentPage}`} className="transform transition-transform duration-150 hover:-translate-y-0.5">
                            <ProductCardFeatured product={product} index={globalIndex} />
                          </div>
                        );
                      } else {
                        return (
                          <div key={`${product.id}-${currentPage}`} className="transform transition-transform duration-150 hover:-translate-y-0.5">
                            <ProductCard product={product} index={globalIndex} />
                          </div>
                        );
                      }
                    })}
              ...
              <div className="flex justify-center">
                <div className="flex flex-col justify-center items-center bg-gradient-to-b from-white to-green-50 rounded-2xl p-8 border border-gray-200 text-center w-full max-w-lg">
                  <div className="mb-6">
                    <div className="w-40 h-40 mx-auto bg-gradient-to-br from-green-100 to-emerald-100 rounded-full flex items-center justify-center mb-4">
                      <Search size={64} className="text-green-400" />
                    </div>
                  </div>
                  ...
                  <Button
                    ...
                    size="large"
                    onClick={resetFilters}
                    className="!bg-gradient-to-r !from-green-600 !to-emerald-600 !border-0 hover:!from-green-700 hover:!to-emerald-700 shadow-lg"
                  >
                    Xóa bộ lọc
                  </Button>
                </div>
              ...
              <div className="flex justify-center mt-8">
                <div className="bg-white rounded-xl border border-gray-200 p-4 shadow-sm">
                  <Pagination
                    ...
                    showLessItems
                    showQuickJumper
                    className="[&_.ant-pagination-item]:rounded-lg [&_.ant-pagination-item]:border-gray-300 [&_.ant-pagination-item-active]:bg-gradient-to-r [&_.ant-pagination-item-active]:from-green-600 [&_.ant-pagination-item-active]:to-emerald-600 [&_.ant-pagination-item-active]:border-transparent"
                  />
                </div>
              </div>
            )}
