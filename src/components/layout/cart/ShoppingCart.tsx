  ...
  const columns = [
    ...
    },
    {
      ...
      render: (_: any, r: any) => {
        ...
        return <span className="font-semibold text-green-600">{formatVND(discountedPrice)}</span>;
      },
    },
    {
      title: 'Số lượng',
    ...
    },
    {
      ...
      render: (_: any, r: any) => {
        ...
        return <span className="font-semibold text-green-600">{formatVND(discountedPrice * r.quantity)}</span>;
      },
    },
    {
      title: '',
            ...
            <Empty
              ...
              description={
                <div className="py-8">
                  ...
                  <Link href="/">
                    <Button type="primary" size="large" icon={<ShoppingCartOutlined />} className="!rounded-xl !bg-gradient-to-r !from-green-600 !to-emerald-600">
                      Tiếp tục mua sắm
                    </Button>
                  </Link>
                </div>
    ...
    <div className="min-h-screen py-4 md:py-8">
      <div className="container mx-auto max-w-7xl md:px-4">
        ...
        <div className="hidden md:flex items-center gap-3 mb-8">
          ...
          <div>
            <h1 className="text-3xl md:text-4xl font-black bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent">
              Giỏ hàng của bạn
            </h1>
        ...
        <div className="md:hidden mb-4">
          <h1 className="text-2xl font-black bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent mb-2">
            Giỏ hàng của bạn
          </h1>
                      ...
                      {promotion && (
                        <>
                          ...
                          <div className="flex justify-between">
                            ...
                            <span className="text-green-600 font-semibold">{formatVND(discountedPrice)}</span>
                          </div>
                        </>
                      )}
                    </div>
            ...
            <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
              ...
              <div className="flex flex-col md:flex-row md:items-center gap-4">
                ...
                <Button
                  ...
                  className="w-full md:w-auto md:min-w-40 !rounded-xl !bg-gradient-to-r !from-green-600 !to-emerald-600 !border-0 hover:!from-green-700 hover:!to-emerald-700"
                >
